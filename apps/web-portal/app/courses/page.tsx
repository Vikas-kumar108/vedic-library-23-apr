...
import { BookOpen, GraduationCap, Clock, ArrowRight, Star } from "lucide-react"
...
const courses = [
  ...
  {
    id: "sanskrit-logic",
    title: "The Logic of Sanskrit Grammar",
    description: "Unlocking the mathematical precision of Paninian grammar for deep scriptural study.",
    instructor: "Acharya Sanskriti",
    duration: "24 Weeks",
    level: "Intermediate",
    enrolled: "800+",
    rating: 4.9,

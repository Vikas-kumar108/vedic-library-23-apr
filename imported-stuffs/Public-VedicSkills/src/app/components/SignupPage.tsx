      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-[24px] p-8 lg:p-10 border border-border shadow-lg">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl lg:text-4xl mb-2">Create your account</h1>
          ...
          <form className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-primary text-primary-foreground py-4 rounded-[16px] hover:opacity-90 transition-opacity shadow-md mt-6"
            >
              Start Learning
            </button>
          </form>
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center gap-3 px-5 py-3.5 bg-background border border-border rounded-[16px] hover:bg-background/80 transition-colors">

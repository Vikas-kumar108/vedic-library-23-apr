  ...
  const onSubmit = async (data: DonationFormData) => {
    ...
    try {
      ...
      if (orderData.orderId.startsWith("order_mock_")) {
        // Simulate success for testing without actual Razorpay
        toast.info("Test Mode", {
          description: "Razorpay is not configured. Simulating successful payment for testing.",
        })
        ...
        if (verifyResponse.ok) {
          ...
          setReceiptNumber(verifyData.donation?.receiptNumber || "MOCK-RECEIPT")
          setIsSuccess(true)
          toast.success("Test Payment Successful!", {
            description: "This is a test. Configure Razorpay for real payments.",
          })
        }

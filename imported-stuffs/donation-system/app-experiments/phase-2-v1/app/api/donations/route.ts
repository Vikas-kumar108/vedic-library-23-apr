...
const donationSchema = z.object({
  ...
  method: z.enum(["UPI", "Bank", "Razorpay"]),
...
export async function GET(req: NextRequest) {
  try {
    ...
    // Users who can view all donations: auditor, csr_partner, ca, director, super_admin
    const adminRoles = ["auditor", "csr_partner", "ca", "director", "super_admin"]

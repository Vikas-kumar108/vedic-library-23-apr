...
"[project]/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime/library.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var Ho = H((Ff, si)=>{
    ...
    P.scrollDown = D + "T";
    P.clearScreen = "\x1Bc";
    P.clearTerminal = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : `${P.eraseScreen}${D}3J${D}H`;
    P.beep = mt;
    P.link = (e, t)=>[
            Yt,
            "8",
...
var Zo = H(($f, zo)=>{
    "use strict";
    var ic = __turbopack_context__.r("[externals]/os [external] (os, cjs)"), Yo = __turbopack_context__.r("[externals]/tty [external] (tty, cjs)"), fe = ai(), { env: J } = process, Je;
...
var ds = H((bg, Le)=>{
    "use strict";
    var Ei = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)"), wi = __turbopack_context__.r("[externals]/path [external] (path, cjs)"), fc = __turbopack_context__.r("[externals]/os [external] (os, cjs)"), gc = __turbopack_context__.r("[externals]/crypto [external] (crypto, cjs)"), hc = ls(), xi = hc.version, yc = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
    function bc(e) {
        let t = {}, r = e.toString();
        r = r.replace(/\r\n?/mg, `
`);
...
var F = zn;
var Mo = _(__turbopack_context__.r("[externals]/fs [external] (fs, cjs)"));
function Zn() {
    let e = process.env.PRISMA_QUERY_ENGINE_LIBRARY;
    if (!(e && Mo.default.existsSync(e)) && process.arch === "ia32") //TURBOPACK unreachable
    ;
}
var Xn = [
    "darwin",
...
var jo = _(__turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)")), ii = _(__turbopack_context__.r("[externals]/fs/promises [external] (fs/promises, cjs)")), Gr = _(__turbopack_context__.r("[externals]/os [external] (os, cjs)"));
...
var Bo = __turbopack_context__.r("[externals]/util [external] (util, cjs)");
var Gu = {
    warn: _e("prisma:warn")
}, Qu = {
...
var pc = _(gi());
var q = _(__turbopack_context__.r("[externals]/path [external] (path, cjs)")), dc = _(gi()), lg = F("prisma:engines");
function ss() {
    return q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../");
}
var ug = "libquery-engine";
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../query-engine-darwin");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../query-engine-darwin-arm64");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../query-engine-debian-openssl-1.0.x");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../query-engine-debian-openssl-1.1.x");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../query-engine-debian-openssl-3.0.x");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../query-engine-linux-static-x64");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../query-engine-linux-static-arm64");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../query-engine-rhel-openssl-1.0.x");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../query-engine-rhel-openssl-1.1.x");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../query-engine-rhel-openssl-3.0.x");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../libquery_engine-darwin.dylib.node");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../libquery_engine-darwin-arm64.dylib.node");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../libquery_engine-debian-openssl-1.0.x.so.node");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../libquery_engine-debian-openssl-1.1.x.so.node");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../libquery_engine-debian-openssl-3.0.x.so.node");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../libquery_engine-linux-arm64-openssl-1.0.x.so.node");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../libquery_engine-linux-arm64-openssl-1.1.x.so.node");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../libquery_engine-linux-arm64-openssl-3.0.x.so.node");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../libquery_engine-linux-musl.so.node");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../libquery_engine-linux-musl-openssl-3.0.x.so.node");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../libquery_engine-rhel-openssl-1.0.x.so.node");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../libquery_engine-rhel-openssl-1.1.x.so.node");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../libquery_engine-rhel-openssl-3.0.x.so.node");
q.default.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime"), "../query_engine-windows.dll.node");
var hi = _(__turbopack_context__.r("[externals]/fs [external] (fs, cjs)")), as = F("chmodPlusX");
function yi(e) {
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
...
var vi = _(ds()), Kr = _(__turbopack_context__.r("[externals]/fs [external] (fs, cjs)"));
var gt = _(__turbopack_context__.r("[externals]/path [external] (path, cjs)"));
function ms(e) {
...
var er = _(__turbopack_context__.r("[externals]/path [external] (path, cjs)"));
function Ri(e) {
...
var Ks = _(Ci());
var Hs = _(__turbopack_context__.r("[externals]/fs [external] (fs, cjs)"));
var Gs = {
    keyword: De,
    entity: De,
    value: (e)=>K(rt(e)),
...
var iu = _(fi());
var ou = __turbopack_context__.r("[externals]/async_hooks [external] (async_hooks, cjs)"), su = __turbopack_context__.r("[externals]/events [external] (events, cjs)"), au = _(__turbopack_context__.r("[externals]/fs [external] (fs, cjs)")), Nr = _(__turbopack_context__.r("[externals]/path [external] (path, cjs)"));
var ae = class e {
    constructor(t, r){
...
var ul = _(__turbopack_context__.r("[externals]/fs [external] (fs, cjs)")), wr = _(__turbopack_context__.r("[externals]/path [external] (path, cjs)"));
function Dn(e) {
...
async function cl(e, t) {
    ...
    let o = await nt(), s = t.generator?.binaryTargets ?? [], a = s.some((d)=>d.native), l = !s.some((d)=>d.value === o), u = ("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime/library.js").match(hm()) === null, c = {
        searchedLocations: i,
...
async function ym(engineType, config) {
    ...
    ("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime/library.js").includes("resolveEnginePath") && searchLocations.push(ss());
...
var fo = _(__turbopack_context__.r("[externals]/os [external] (os, cjs)")), Rl = _(__turbopack_context__.r("[externals]/path [external] (path, cjs)"));
...
"[project]/playground/ui-vedic-library-frontend-v2/lib/generated/client/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

Object.defineProperty(exports, "__esModule", {
    value: true
});
const { PrismaClientKnownRequestError, PrismaClientUnknownRequestError, PrismaClientRustPanicError, PrismaClientInitializationError, PrismaClientValidationError, getPrismaClient, sqltag, empty, join, raw, skip, Decimal, Debug, objectEnumValues, makeStrictEnum, Extensions, warnOnce, defineDmmfProperty, Public, getRuntime, createParam } = __turbopack_context__.r("[project]/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime/library.js [app-route] (ecmascript)");
const Prisma = {};
...
exports.Prisma.LibraryNodeScalarFieldEnum = {
    id: 'id',
    parentId: 'parentId',
    path: 'path',
    name: 'name',
 ...
 */ const config = {
    "generator": {
        ...
        "output": {
            "value": "/Users/ppublications/Workspace/system/ui-lab/playground/ui-vedic-library-frontend-v2/lib/generated/client",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/Users/ppublications/Workspace/system/ui-lab/playground/ui-vedic-library-frontend-v2/prisma/schema.prisma",
        "isCustomOutput": true
    },
    "relativeEnvPaths": {
        "rootEnvPath": null,
    ...
    "inlineSchemaHash": "270cc3cfd19e89f24311ae630777aa1e60f19083a8f6280b84444f62bf6995b4",
    "copyEngine": true
};
const fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
config.dirname = ("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client");
if (!fs.existsSync(path.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client"), 'schema.prisma'))) {
...
config.runtimeDataModel = JSON.parse("{\"models\":{\"LibraryNode\":{\"dbName\":null,\"schema\":null,\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"parentId\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":true,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"path\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"name\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"sanskrit\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"type\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"order\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"Int\",\"nativeType\":null,\"default\":0,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"verseCount\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Int\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"structure\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Json\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"meta\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Json\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"parent\",\"kind\":\"object\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"LibraryNode\",\"nativeType\":null,\"relationName\":\"TreeHierarchy\",\"relationFromFields\":[\"parentId\"],\"relationToFields\":[\"id\"],\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"children\",\"kind\":\"object\",\"isList\":true,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"LibraryNode\",\"nativeType\":null,\"relationName\":\"TreeHierarchy\",\"relationFromFields\":[],\"relationToFields\":[],\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[],\"uniqueIndexes\":[],\"isGenerated\":false},\"Verse\":{\"dbName\":null,\"schema\":null,\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"chapterNumber\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Int\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"verseNumber\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Int\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"unitType\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"scripts\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Json\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"synonyms\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Json\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"segmentation\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Json\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"anvaya\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Json\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"anvayaTranslation\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Json\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"meter\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"theme\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"relations\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Json\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"commentaries\",\"kind\":\"object\",\"isList\":true,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Commentary\",\"nativeType\":null,\"relationName\":\"CommentaryToVerse\",\"relationFromFields\":[],\"relationToFields\":[],\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"translations\",\"kind\":\"object\",\"isList\":true,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Translation\",\"nativeType\":null,\"relationName\":\"TranslationToVerse\",\"relationFromFields\":[],\"relationToFields\":[],\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[],\"uniqueIndexes\":[],\"isGenerated\":false},\"Author\":{\"dbName\":null,\"schema\":null,\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"Int\",\"nativeType\":null,\"default\":{\"name\":\"autoincrement\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"name\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":true,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"role\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"sampradaya\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"description\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"translations\",\"kind\":\"object\",\"isList\":true,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Translation\",\"nativeType\":null,\"relationName\":\"AuthorToTranslation\",\"relationFromFields\":[],\"relationToFields\":[],\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"commentaries\",\"kind\":\"object\",\"isList\":true,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Commentary\",\"nativeType\":null,\"relationName\":\"AuthorToCommentary\",\"relationFromFields\":[],\"relationToFields\":[],\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[],\"uniqueIndexes\":[],\"isGenerated\":false},\"Translation\":{\"dbName\":null,\"schema\":null,\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"Int\",\"nativeType\":null,\"default\":{\"name\":\"autoincrement\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"verseId\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":true,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"authorId\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":true,\"hasDefaultValue\":false,\"type\":\"Int\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"language\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"description\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"verse\",\"kind\":\"object\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Verse\",\"nativeType\":null,\"relationName\":\"TranslationToVerse\",\"relationFromFields\":[\"verseId\"],\"relationToFields\":[\"id\"],\"relationOnDelete\":\"Cascade\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"author\",\"kind\":\"object\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Author\",\"nativeType\":null,\"relationName\":\"AuthorToTranslation\",\"relationFromFields\":[\"authorId\"],\"relationToFields\":[\"id\"],\"relationOnDelete\":\"Cascade\",\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[],\"uniqueIndexes\":[],\"isGenerated\":false},\"Commentary\":{\"dbName\":null,\"schema\":null,\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"Int\",\"nativeType\":null,\"default\":{\"name\":\"autoincrement\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"verseId\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":true,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"authorId\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":true,\"hasDefaultValue\":false,\"type\":\"Int\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"language\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"description\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"sampradaya\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"subCommentaries\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Json\",\"nativeType\":null,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"verse\",\"kind\":\"object\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Verse\",\"nativeType\":null,\"relationName\":\"CommentaryToVerse\",\"relationFromFields\":[\"verseId\"],\"relationToFields\":[\"id\"],\"relationOnDelete\":\"Cascade\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"author\",\"kind\":\"object\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Author\",\"nativeType\":null,\"relationName\":\"AuthorToCommentary\",\"relationFromFields\":[\"authorId\"],\"relationToFields\":[\"id\"],\"relationOnDelete\":\"Cascade\",\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[],\"uniqueIndexes\":[],\"isGenerated\":false}},\"enums\":{},\"types\":{}}");
defineDmmfProperty(exports.Prisma, config.runtimeDataModel);
config.engineWasm = undefined;
config.compilerWasm = undefined;
const { warnEnvConflicts } = __turbopack_context__.r("[project]/playground/ui-vedic-library-frontend-v2/lib/generated/client/runtime/library.js [app-route] (ecmascript)");
warnEnvConflicts({
...
path.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client"), "libquery_engine-darwin-arm64.dylib.node");
path.join(process.cwd(), "lib/generated/client/libquery_engine-darwin-arm64.dylib.node");
// file annotations for bundling tools to include these files
path.join(("TURBOPACK compile-time value", "/ROOT/playground/ui-vedic-library-frontend-v2/lib/generated/client"), "schema.prisma");
path.join(process.cwd(), "lib/generated/client/schema.prisma");
}),
"[project]/playground/ui-vedic-library-frontend-v2/app/api/library/tree/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$playground$2f$ui$2d$vedic$2d$library$2d$frontend$2d$v2$2f$lib$2f$generated$2f$client$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/playground/ui-vedic-library-frontend-v2/lib/generated/client/index.js [app-route] (ecmascript)");
;
;
const prisma = new __TURBOPACK__imported__module__$5b$project$5d2f$playground$2f$ui$2d$vedic$2d$library$2d$frontend$2d$v2$2f$lib$2f$generated$2f$client$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaClient"]();
async function GET() {
    try {
        const nodes = await prisma.libraryNode.findMany({
            orderBy: {
                order: 'asc'
            }
        });
        ...
        nodes.forEach((n)=>{
            nodesMap[n.id] = {
                id: n.id,
                name: n.name,
                sanskrit: n.sanskrit || undefined,
                verseCount: n.verseCount || undefined,
                type: n.type,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0j-3rji._.js.map